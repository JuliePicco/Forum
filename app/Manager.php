<?php
    ...
    abstract class Manager{
        ...
        //$data = ['username' => 'Squall', 'password' => 'dfsyfshfbzeifbqefbq', 'email' => 'sql@gmail.com'];

        public function add($data){
            //$keys = ['username' , 'password', 'email']
            $keys = array_keys($data);
            //$values = ['Squall', 'dfsyfshfbzeifbqefbq', 'sql@gmail.com']
            ...
            $sql = "INSERT INTO ".$this->tableName."
                    ...
                    VALUES
                    ('".implode("','",$values)."')";
                    //"'Squall', 'dfsyfshfbzeifbqefbq', 'sql@gmail.com'"
            /*
                INSERT INTO user (username,password,email) VALUES ('Squall', 'dfsyfshfbzeifbqefbq', 'sql@gmail.com') 
            */
            try{
